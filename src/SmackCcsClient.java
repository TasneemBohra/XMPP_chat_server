...
public class SmackCcsClient {
	...
	static final String REG_ID_STORE = "/home/tasneem/workspace/XMPP Server/src/gcmchat.txt";	
	...
	public void handleIncomingDataMessage(Map<String, Object> jsonObject) {
		...
		System.out.println("handleIncomingDataMessage - from :"+from);

		// PackageName of the application that sent this message.
		String category = jsonObject.get("category").toString();
		
		System.out.println("handleIncomingDataMessage - category :"+category);
		...
		System.out.println("handleIncomingDataMessage - action :"+action);
		...
		if ("ECHO".equals(action)) {
			...
			try {
				...
				System.out.println("Registration map is empty");
			}
	...
	public void writeToFile(String name, String regId) throws IOException {
		...
		Map<String, String> regIdMap = readFromFile();
		System.out.println("writeToFile - registration id :"+regId);
		System.out.println("writeToFile - name :"+name);
		...
		for (Map.Entry<String, String> entry : regIdMap.entrySet()) {
			...
			System.out.println("writeToFile 2 - registration id :"+entry.getValue());
			System.out.println("writeToFile 2 - name :"+entry.getKey());
		}
		out.println(name + "," + regId);
		out.close();
		} else {
			System.err.println("writeToFile - regIdMap is empty");
		}
	...
	public Map<String, String> readFromFile() {
		...
		try {
			...
			while ((regIdLine = br.readLine()) != null) {
				System.out.println("reading line : "+regIdLine);
				String[] regArr = regIdLine.split(",");
				regIdMap.put(regArr[0], regArr[1]);
				System.out.println("readFromFile - arg[0] :"+regArr[0]);
				System.out.println("readFromFile - arg[1] :"+regArr[1]);
			}
			br.close();
 ...
 public static void main(String [] args) {
    final String userName = "559461873841" + "@gcm.googleapis.com";
    final String password = "AIzaSyCflSxp7q3-ysjF-n-hgkQLpEFkCOBWIJQ";
